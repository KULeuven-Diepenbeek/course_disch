...
{{% figure src="/images/900/910_fsm/FSM_verkeerslicht_schematisch.png" %}}
{{% /column %}}
{{% column %}}
{{% figure src="/images/900/910_fsm/FSM_verkeerslicht.png" %}}
{{% /column %}}
{{% /multiHcolumn %}}
...
{{% /column %}}
{{% column %}}
{{% figure src="/images/900/910_fsm/next_state.png" %}}
{{% /column %}}
{{% /multiHcolumn %}}
...
{{% /column %}}
{{% column %}}
{{% figure src="/images/900/910_fsm/state_register.png" %}}
{{% /column %}}
{{% /multiHcolumn %}}
...
{{% /column %}}
{{% column %}}
{{% figure src="/images/900/910_fsm/output_functie.png" %}}
{{% /column %}}
{{% /multiHcolumn %}}
