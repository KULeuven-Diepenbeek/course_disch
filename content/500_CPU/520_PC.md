...
Voordat de processor geïmplementeerd kan worden, moet dus eerst de program counter gemaakt worden. In het volgende hoofdstuk wordt er in detail ingegaan op de program counter. Functioneel gezien is het voorlopig isvoldoende dat de program counter gewoon optelt met stappen van 4. We gaan nu echter wat extra moeite doen zodat we in de toekomst hier niet meer op moeten terugkomen.
...
{{% notice tip %}}
**PROTIP** maak eerst een ontwerp, begin dan pas aan de beschrijving !
{{% /notice %}}